...
class MackeyGlassParams(SyntheticSequenceParams):
    ...
    init_noise_std: float = Field(default=0.0, ge=0, description="Std of an optional seeded Gaussian perturbation added to the history block; 0 yields an exact deterministic init.")
