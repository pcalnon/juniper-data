...
from .defaults import MAX_NOISE, MAX_POINTS, MAX_ROTATIONS, MAX_SPIRALS, MIN_NOISE, MIN_POINTS, MIN_ROTATIONS, MIN_SPIRALS, SPIRAL_DEFAULT_CLOCKWISE, SPIRAL_DEFAULT_DISTRIBUTION, SPIRAL_DEFAULT_N_POINTS, SPIRAL_DEFAULT_N_ROTATIONS, SPIRAL_DEFAULT_N_SPIRALS, SPIRAL_DEFAULT_NOISE, SPIRAL_DEFAULT_ORIGIN, SPIRAL_DEFAULT_RADIUS, SPIRAL_DEFAULT_RANDOM_VALUE_SCALE, SPIRAL_DEFAULT_SEED, SPIRAL_DEFAULT_TEST_RATIO, SPIRAL_DEFAULT_TRAIN_RATIO
