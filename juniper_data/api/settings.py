...
from juniper_data.core.limits import CSV_IMPORT_DEFAULT_ALLOW_TRUNCATION, CSV_IMPORT_DEFAULT_MAX_BYTES, EQUITIES_DEFAULT_ALLOW_TRUNCATION, EQUITIES_DEFAULT_INCOMPLETE_ROWS, EQUITIES_DEFAULT_MAX_SYMBOLS
...
_JUNIPER_DATA_API_EQUITIES_INCOMPLETE_ROWS_DEFAULT: str = EQUITIES_DEFAULT_INCOMPLETE_ROWS
...
class Settings(BaseSettings):
    ...
    # What to do with unresolvable-fundamentals rows once allow_truncation has
    # opened the gate. Env var JUNIPER_DATA_EQUITIES_INCOMPLETE_ROWS, or the
    # matching .env entry -- the deployment-wide default an interactive consumer
    # overrides per request.
    equities_incomplete_rows: Literal["accept", "drop"] = _JUNIPER_DATA_API_EQUITIES_INCOMPLETE_ROWS_DEFAULT  # type: ignore[assignment]
