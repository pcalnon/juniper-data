...
- The main repo directory is accessible at `/home/pcalnon/Development/python/Juniper/juniper-data`
...
# Main repo
MAIN_REPO="/home/pcalnon/Development/python/Juniper/juniper-data"
```
...
gh pr create --repo pcalnon/juniper-data --base main --head "$OLD_BRANCH" \
