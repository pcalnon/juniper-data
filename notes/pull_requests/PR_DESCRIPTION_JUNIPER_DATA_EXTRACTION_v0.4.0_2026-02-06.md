...
- **Documentation**
  ...
  - `AGENTS.md` — Complete project guide (updated from JuniperCanopy)# Pull Request: JuniperData Service Extraction & Integration Infrastructure
...
#### PR 2: NPZ Artifact Schema (Data Contract)
